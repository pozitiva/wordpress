<?php
 /**
 * Title: Blog 2
 * Slug: variations/page-island-blog-five
 * Description: Add Blog 2 Template
 * Categories: posts
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"40px","bottom":"60px","right":"30px","left":"30px"}}},"layout":{"type":"constrained","contentSize":"1140px"}} -->
<div class="wp-block-group alignfull" style="padding-top:40px;padding-right:30px;padding-bottom:60px;padding-left:30px"><!-- wp:heading {"style":{"color":{"text":"#242925"},"elements":{"link":{"color":{"text":"#242925"}}},"typography":{"fontSize":"2.5rem"},"spacing":{"margin":{"bottom":"50px"}}},"fontFamily":"hedvig-letters-serif-regular"} -->
...
<!-- wp:heading {"textAlign":"center","style":{"color":{"text":"#242925"},"elements":{"link":{"color":{"text":"#242925"}}},"typography":{"fontSize":"2.4rem"}},"fontFamily":"hedvig-letters-serif-regular"} -->
<h2 class="wp-block-heading has-text-align-center has-text-color has-link-color has-hedvig-letters-serif-regular-font-family" style="color:#242925;font-size:2.4rem">I’m Lisa, a travel enthusiast with a passion for exploring the world's greatest hidden gems.</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"1.3rem"},"color":{"text":"#242925"},"elements":{"link":{"color":{"text":"#242925"}}}}} -->
<p class="has-text-align-center has-text-color has-link-color" style="color:#242925;font-size:1.3rem">Through my blog, I share my experiences, from breathtaking natural landscapes to vibrant cultural encounters</p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"right","flexWrap":"wrap","orientation":"horizontal"},"style":{"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"margin":{"top":"30px"}}}} -->
<div class="wp-block-buttons" style="margin-top:30px"><!-- wp:button {"width":100,"style":{"typography":{"textTransform":"capitalize","lineHeight":"1","fontStyle":"normal","fontWeight":"700","fontSize":"1rem"},"spacing":{"padding":{"left":"40px","right":"40px","top":"1.1rem","bottom":"1.1rem"}},"color":{"text":"#242925","background":"#f0f2e9"},"border":{"radius":"2.5rem","color":"#242925","style":"solid","width":"1px"}},"className":"is-style-fill","fontFamily":"work-sans-regular"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 has-custom-font-size is-style-fill has-work-sans-regular-font-family" style="font-size:1rem;font-style:normal;font-weight:700;line-height:1;text-transform:capitalize"><a class="wp-block-button__link has-text-color has-background has-border-color wp-element-button" style="border-color:#242925;border-style:solid;border-width:1px;border-radius:2.5rem;color:#242925;background-color:#f0f2e9;padding-top:1.1rem;padding-right:40px;padding-bottom:1.1rem;padding-left:40px">More About Me</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
